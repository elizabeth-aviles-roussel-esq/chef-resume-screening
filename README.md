# Kitchen Hire — AI-Native Culinary Hiring Workflow
...
| `resume-analyzer.jsx` | React app — multi-source analyzer with candidate stack |
...
2. Open `prompt_template.txt` and copy the prompt
3. Fill in the role and any custom details
4. Paste a resume at the bottom
5. Read the output and score the candidate
...
2. In your Craigslist job posting, set replies to go to that address
3. Connect your Gmail account to Claude.ai via the Gmail integration
   in Settings → Integrations
4. In the Resume Analyzer tool, enter the dedicated email address
...
2. Request API access for your employer account
3. Provide your webhook endpoint (generated in the Resume Analyzer tool)
4. Culinary Agents will configure your account to route applications
