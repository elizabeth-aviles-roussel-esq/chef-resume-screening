...
const HIRING_SYSTEM_PROMPT = `You are an expert culinary hiring consultant with deep knowledge of the NYC restaurant industry. You are helping hire kitchen staff for a Casual American restaurant in NYC with 80 seats. The concept is ingredient-driven Casual American — seasonal, technique-focused, approachable but refined. Benchmark restaurants include Gramercy Tavern, Estela, Loring Place, ABC Kitchen, Olmsted, Vic's, and The Dutch.
...
Analyze the resume provided and return ONLY a valid JSON object with this exact structure, no preamble, no markdown, no backticks:
{
  ...
  "volumeExperience": <string - 1-2 sentence assessment of volume and format fit for an 80-seat kitchen>,
  "cuisineAlignment": <string - 1-2 sentences on how well their background matches Casual American cooking>,
  ...
  "tags": [<2-4 short tags e.g. "NYC pedigree", "Casual American", "Seasonal kitchen", "NYC pedigree", "Red flag", "Strong pedigree">],
  "highVolumeYears": <number - estimated years in NYC independent restaurant kitchens>,
      ...
      <div className="app">
        ...
        <div className="topbar">
          <div>
            ...
            <div className="concept">Casual American · 80 Seats · NYC</div>
          </div>
          ...
          <div className="content">
            {candidates.length === 0 ? (
              ...
              <>
                ...
                <div className="page-sub">Sorted by fit score · Casual American · 80 seats · NYC</div>
                      ...
                      {isOpen && (
                        <div className="card-body">
                          <div className="manual-row">
                            ...
                            <div className="bar-row">
                              <div className="bar-lbl">NYC kitchen</div>
